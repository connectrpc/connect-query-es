...
export declare const useListMutation: (
    ...
    queryOptions?: Partial<UseMutationOptions<ListResponse, ConnectError, PartialMessage<ListRequest>>>
) => UseMutationResult<ListResponse,ConnectError,PartialMessage<ListRequest>, unknown>;
