 ...
 *
 * @generated from message SayRequest
 */
export class SayRequest extends Message<SayRequest> {
  ...
  static readonly typeName = "SayRequest";
 ...
 *
 * @generated from message SayResponse
 */
export class SayResponse extends Message<SayResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "SayResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sentence", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message ConverseRequest
 */
export class ConverseRequest extends Message<ConverseRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ConverseRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sentence", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 * ConverseRequest.
 *
 * @generated from message ConverseResponse
 */
export class ConverseResponse extends Message<ConverseResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ConverseResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sentence", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message IntroduceRequest
 */
export class IntroduceRequest extends Message<IntroduceRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "IntroduceRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message IntroduceResponse
 */
export class IntroduceResponse extends Message<IntroduceResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "IntroduceResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sentence", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
