...
describe('generateTs', () => {
  const expected = (target: Target, importHookFrom: string) => [
    ...
    '// limitations under the License.',
    '',
    `// @generated by protoc-gen-connect-query-with-hooks v${
      packageJson.version
    ...
    `import { UseBaseQueryOptions, useInfiniteQuery, UseInfiniteQueryOptions, useMutation, UseMutationOptions, useQuery } from "${
